...
async function run(){
    ...
    try{
        ...
        const userCollection = client.db("doctors_care").collection("users");
        const doctorCollection = client.db('doctors_care').collection('doctors');
        const paymentCollection = client.db('doctors_care').collection('payments');
